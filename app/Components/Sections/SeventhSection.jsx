...
const SeventhSection = () => {
    const renderTestimonial = (testimonial, index) => (
        <div className="bg-white rounded-2xl shadow-2xl p-6 lg:p-8 duration-300 mx-auto text-center w-[260px] sm:w-[300px] md:w-[350px] md:h-[50vh] mb-5 mt-3">
        ...
        <div className='flex justify-center items-center p-10 bg-white max-w-screen overflow-hidden'>
            <div>
                ...
                <Carousel
                    ...
                    autoPlay={true}
                    interval={3000}
                    className="md:w-[77vw] mx-auto md:h-[60vh]"
